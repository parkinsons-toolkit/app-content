...
- Wear items that are slightly larger size, loose fitting or stretchy fabrics.
...
Here's your content converted into **Markdown format** with no wording changes:
...
- **Mattress Variators or Pillow Lifters** help lift you up into a seated position.  
  They are more effective for fairly thin mattresses as thicker mattresses are difficult to bend and can scrunch up in the middle (less helpful and less comfortable). Mattress raisers come in different types:  
...
- They can be used to help you sit up from lying down and can help you manage symptoms or dizziness or ankle swelling  
- Hospital beds are usually height-adjustable and may have side rails. They may have casters or wheels, which allow the bed to be moved. These can be provided by health professionals such as your district nurse if needed  
- Electric profiling beds tend to look more like an ordinary bed. Some double bed styles are available that split the mattress so each person can adjust the mattress to the position they want. They can raise up and down and some can raise your upper body and provide a knee break
...
- Special raisers for chairs that can make it easier to stand up from  
...
- **Plate guards** clip onto the plate and provide an upright ring around it  
  ...
  - Note some are positioned about an inch in from the outer edge of plate, which can decrease the usable area of the plate
...
- **Non-slip food mats** are made of a special tacky silicone or plastic material, which you put under a plate or bowl to stop it from moving around while you eat  
  ...
  - Come in range of colours – you can buy them pre-cut as a placemat, or you can buy the material and cut to the size you need
...
- **Nosey cups** have a section cut out on one side, opposite the position of the mouth when drinking  
  - The cut-out allows the person drinking to tilt and drain the cup more easily with limited neck movement  
...
- **Key safe:** This is a small secure box, fitted to a wall outside the front door to hold the keys to your home. It requires a code to access: you choose whom to give the code to.  
  - This can be very useful as multiple sets of keys do not need to be provided to family members or healthcare professionals  
  - It will also allow people to access the house in case of an emergency
...
- More information about these systems is available on the NHS website and the Which? Later Life Care website  
...
5. Local pharmacies and disability shops sell equipment. Short term hire can be possible from local organisations, such as Red Cross Society.  
...
Details for all of these and for more information about Home Help can be found at the end of this section in the More Information section.  
...
Please also see the Services and Groups page for sources of support. Please look at the bottom of the table for further information about call charges.  

| Organisation                     | Information about | Phone Number | Website |
|----------------------------------|-------------------|---------------|---------|
| **Age UK** | Advice about increasing activity, accessible travel information. Home Help: Different services are offered in different regions. You can enter your postcode to their website to see what is available locally. | 0800 678 1602 (Free helpline: 8am-7pm) | www.ageuk.org.uk <br> www.ageuk.org.uk/services/in-your-area/home-help/ |
| **Royal College of Occupational Therapists** | Can investigate private occupational therapists. | 020 7357 6480 * | www.rcot.co.uk |
| **British Red Cross** | Can provide information about mobility aids available to loan in your area. Offer Home Help services, dependent on area. | 0344 871 11 11 ** | www.redcross.org.uk <br> www.redcross.org.uk/get-help/get-support-at-home |
| **Royal Voluntary Service** | Offer Home Help services, dependent on area. | 0808 196 3646 (Free telephone line: 8am-8pm) | www.royalvoluntaryservice.org.uk/our-services/supporting-people |
| **Disabled Living Foundation** | Provides information and advice on aids and equipment. They have a range of factsheets that you can download from their website. | 0300 999 0004 *** | www.dlf.org.uk <br> Search ‘AskSARA’ |
| **Parkinson’s UK website** | In-depth information on mobility equipment and many other topics that can be read online, printed out, or mailed to you. | 0808 800 0303 (Free helpline: 9am-7pm Mon–Fri, 10am–2pm Sat) | www.parkinsons.org.uk/information-and-support/daily-living-equipment |
| **Independent Age** | Advice and support for older people, including advice on getting extra help at home. | 0800 319 6789 (Free helpline) | www.independentage.org/get-advice/support-care/help-at-home/getting-extra-help-at-home |
| **Elderly Accommodation Counsel** | Advice and support for older people. Directory of housing and care service. | | www.eac.org.uk <br> www.housingcare.org |
| **Which? Later Life Care** | Independently tests and reviews products and services. Offers free advice on caring for older people and an online Care Services Directory. | | www.which.co.uk/later-life-care |

> \* Calls cost up to 13p/minute from landlines, between 3p–55p/minute from mobile phones.  
> \** Calls cost up to 9p/minute from landlines, between 3p–55p/minute from mobile phones.  
...
- **Contributory ESA**: This has now been replaced by ‘New Style ESA’ for new claimants. To be able to claim, you must have paid enough National Insurance contribution in specific tax years (National Insurance credits count). Payment of contributory ESA is often limited to 12 months.
...
✓ Must be between the ages of 16 and State Pension age (you can check the State Pension age using the government online calculator)  
✓ Be living in the UK  
...
✓ Tell your employer that you’re sick before their deadline or within 7 days of sickness. If you are off sick for more than 7 consecutive days you will need to provide a ‘fit note’ (also called a doctor’s certificate or ‘sick’ note). Your GP or hospital doctor will be able to issue you a fit note.  

For more information on benefits and how to apply for them, visit GOV.UK: Benefits. You can also get help and advice from the charity ‘Citizens Advice’. You can find links in our More Information section below.
...
You're welcome! Here's the **continuation** of the Markdown-formatted document:

---

# More information

## Sources of benefits advice

Don’t worry if this seems complicated. There are organisations that can offer personalised support:

- **Citizens Advice** – they offer free advice about benefits and financial issues. [www.citizensadvice.org.uk](https://www.citizensadvice.org.uk)
- **Parkinson’s UK** – has information and a free confidential helpline: 0808 800 0303 or [www.parkinsons.org.uk](https://www.parkinsons.org.uk)
- **Age UK** – provides information and support to older people. [www.ageuk.org.uk](https://www.ageuk.org.uk)
- **GOV.UK** – official government website with information about eligibility and how to claim benefits: [www.gov.uk](https://www.gov.uk)

You can also try one of the government’s **benefits calculators** to find out what you may be entitled to:
- [Turn2us Benefits Calculator](https://benefits-calculator.turn2us.org.uk/)
- [Policy in Practice Benefits Calculator](https://www.betteroffcalculator.co.uk/)
- [entitledto Benefits Calculator](https://www.entitledto.co.uk/)

---

**Note:** This document is for general guidance only and does not constitute legal or financial advice. For personalised support, consult one of the services listed above.
```
