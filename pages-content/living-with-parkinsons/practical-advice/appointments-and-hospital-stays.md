...
Make sure you tell staff you have Parkinson’s. It is helpful to give the contact details of your Parkinson’s specialist team. If it is a planned hospital admission they can liaise in advance. There is often overlap in the questions that different healthcare professionals ask and it can be frustrating to repeat. Consider using the **Health Conditions**, **Health Profile** and **Medications** tabs within the <a href="/my-tracker" class="internal-link">My Tracker</a> to record some of this key information. Then you can show the summary to multiple people, clarifying details as needed.
